...
//: When you select and drag on an entity in the knowledge graph on the right, you can see all the **Relation** information related to the **Entity** you have selected from the top of the view, and of course, you can zoom in and out the knowledge graph as well.
//:
...
//: - - -
//: After experiencing the knowledge graph, why not try to create a knowledge graph on your own?
//: ## [Next page](@next)
